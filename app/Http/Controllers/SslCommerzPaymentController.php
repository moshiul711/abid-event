...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $update_product = DB::table('orders')
            ->where('transction_id', $post_data['tran_id'])
            ->updateOrInsert([
                'customer_id'      => 213,
                'order_total'      => 333,
                'tax_total'        => 437,
                ...
                'delivery_address' => 'sddfd',
                'payment_method'   => 'online',
                'transction_id'    => $post_data['tran_id'],
...
//        return $request;
        ...
        $order_details = DB::table('bookings')
            ...
            ->select('transaction_id','payment_amount', 'booking_status', 'currency', 'booking_total')->first();
        ...
        } else if ($order_details->booking_status == 'Processing' || $order_details->booking_status == 'Complete') {
            /*
    ...
    public function fail(Request $request)
    {
        ...
        $order_details = DB::table('bookings')
            ->where('transaction_id', $tran_id)
            ->select('transaction_id', 'booking_status', 'currency', 'booking_amount')->first();
