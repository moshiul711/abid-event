        ...
        <div class="col-lg col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal"  action="{{route('food.create')}}"  method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-4">
                            <label for="firstName" class="col-md-3 form-label">Catering Name</label>
                            <div class="col-md-9">
                                <input class="form-control" name="name" placeholder="Enter Catering Name" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">Catering Details</label>
                            <div class="col-md-9">
                                <textarea style="height:150px" class="form-control" name="description"  id="cat_description" placeholder="Enter Catering full details" type="text"></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">Catering Selling Price</label>
                            <div class="col-md-9">
                                <input class="form-control" name="s_price"  placeholder="Catering Selling Price" id="cat_description" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">Catering Regular Price</label>
                            <div class="col-md-9">
                                <input class="form-control" name="r_price"  placeholder="Catering Regular Price" id="cat_description" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            <label for="email" class="col-md-3 form-label">Catering Image </label>
                            <div class="col-md-9">
                                <input class="form-control" name="image"  placeholder="Enter Catering Image" type="file">
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <button class="btn btn-primary" type="submit">Add Catering</button>
                    </form>
                </div>
            </div>
        </div>
