            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="breadcrumb-nav">
                        ...
                        <li><a href="javascript:void(0)">Dhaka Division</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                ...
                                                <div class="button">
                                                    <a href="{{route('cart.add')}}" class="btn"><i class="lni lni-cart"></i>Book This Venue</a>
                                                </div>
                                            </div>
                                            <div class="product-info">
                                                <h4 class="title">
                                                    <a href="{{route('venue-detail', ['id' => $venue->id])}}">{{ $venue->name}}</a>
                                                </h4>
                                                <div class="price">
