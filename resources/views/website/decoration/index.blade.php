            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="breadcrumbs-content">
                        <h1 class="page-title">Weeding Decoration</h1>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="breadcrumb-nav">
                        <li><a href="{{route('home')}}"><i class="lni lni-home"></i> Home</a></li>
                        <li><a href="javascript:void(0)">Weeding Decoration</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                ...
                                                <div class="button">
                                                    <a href="{{route('cart.add')}}" class="btn"><i class="lni lni-cart"></i>Book Design</a>
                                                </div>
                                            </div>
                                            <div class="product-info">
                                                <h4 class="title">
                                                    <a href="{{route('decoration-detail', ['id' => $decoration->id])}}">{{ $decoration->name}}</a>
                                                </h4>
                                                <div class="price">
                                                    <span>{{ $decoration->s_price}}</span>
                                                    <span class="discount-price">{{ $decoration->r_price}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
